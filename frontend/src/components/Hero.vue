<script setup>
import fotoProfil from '@/assets/muka.png'
</script>
...
<template>
  <section id="profil" class="container mx-auto px-6 py-20 flex flex-col md:flex-row items-center">
    <div class="md:w-1/2 mb-10 md:mb-0">
      ...
      >
        Halo, Saya <span class="text-sky-500">Desta Adriyan Saputra</span>
      </h1>
      ...
      <a
        href="#kontak"
        class="bg-sky-500 text-white font-bold py-3 px-6 rounded-lg hover:bg-sky-600 transition-colors duration-300 inline-block animate-slide-in-left"
